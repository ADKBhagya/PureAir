<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top" 
     style="font-family: 'Poppins', sans-serif; height: 80px; width: 1400px; border-radius: 20px; 
            margin: 10px auto; z-index: 9999; left: 0; right: 0; 
    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse justify-content-between" style=" gap:20px;" id="navbarContent">
            ...
            <ul class="navbar-nav mx-auto gap-3" style="font-size:18px;">
                ...
                <li class="nav-item">
                    <a class="nav-link fw-semibold nav-link-custom {{ request()->is('airquality') ? 'active' : '' }}" href="#">Air Quality</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-semibold nav-link-custom {{ request()->is('reports') ? 'active' : '' }}" href="#">Reports</a>
                </li>
            </ul>
